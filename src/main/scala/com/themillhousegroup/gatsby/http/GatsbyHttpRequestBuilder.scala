...
class GatsbyHttpRequestBuilder(commonAttributes: CommonAttributes,
    ...
    val url: String,
    val requestName: String) extends AbstractHttpRequestBuilder[GatsbyHttpRequestBuilder](commonAttributes, httpAttributes) {

  def newInstance(commonAttributes: CommonAttributes): GatsbyHttpRequestBuilder = new GatsbyHttpRequestBuilder(commonAttributes, httpAttributes, url, requestName)

  def newInstance(httpAttributes: HttpAttributes): GatsbyHttpRequestBuilder = new GatsbyHttpRequestBuilder(commonAttributes, httpAttributes, url, requestName)
